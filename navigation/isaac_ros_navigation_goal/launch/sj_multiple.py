...
def generate_launch_description():
    ...
    wh_nav2_bringup_dir = get_package_share_directory("iw_hub_navigation")
    nav2_bringup_dir = get_package_share_directory("nav2_bringup")
    nav2_bringup_launch_dir = os.path.join(nav2_bringup_dir, "launch")

    rviz_config_dir = os.path.join(wh_nav2_bringup_dir, "rviz2", "iw_hub_navigation.rviz")

    # Names and poses of the robots
    robots = [{"name": "agent1"}, {"name": "agent2"}]

    # Common settings
    ENV_MAP_FILE = "sj_iw_hub_navigation_params.yaml"
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map",
        default_value=os.path.join(wh_nav2_bringup_dir, "maps", ENV_MAP_FILE),
    ...
    declare_robot1_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            wh_nav2_bringup_dir, "params", "wh_agent_1_2", "agent1_params.yaml"
        ),
    ...
    declare_robot2_params_file_cmd = DeclareLaunchArgument(
        "agent2_params_file",
        default_value=os.path.join(
            wh_nav2_bringup_dir, "params", "wh_agent_1_2", "agent2_params.yaml"
        ),
            ...
            [
                ...
                IncludeLaunchDescription(
                    PythonLaunchDescriptionSource(
                        os.path.join(wh_nav2_bringup_dir, "launch", "sj_iw_hub_navigation.launch.py")
                    ),
                    launch_arguments={
