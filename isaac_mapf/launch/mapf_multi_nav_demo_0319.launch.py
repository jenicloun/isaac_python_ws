...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package="isaac_mapf",
            executable="mapf_goal_checker",
            name='carter1_goal_checker',
            output='screen',
            parameters=[{
                "robot_name": "carter1",
                "plan_topic": "/mapf/carter1/plan",
                "goal_reached_topic": "/mapf/carter1/goal_reached",
        ...
        Node(
            package="isaac_mapf",
            executable="mapf_goal_checker",
            name='carter2_goal_checker',
            output='screen',
            parameters=[{
                "robot_name": "carter2",
                "plan_topic": "/mapf/carter2/plan",
                "goal_reached_topic": "/mapf/carter2/goal_reached",
        ...
        Node(
            package="isaac_mapf",
            executable="mapf_goal_checker",
            name='carter3_goal_checker',
            output='screen',
            parameters=[{
                "robot_name": "carter3",
                "plan_topic": "/mapf/carter3/plan",
                "goal_reached_topic": "/mapf/carter3/goal_reached",
